        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0" data-aos="fade-right" data-aos-duration="1500">
              I am an AI and robotics engineer from Amman, Jordan, with a B.Sc. in Artificial Intelligence from Al Zaytoonah University. I’m passionate about exploring new technologies, solving real-world problems, and building impactful projects—from robotics and automation to smart-home systems—while always striving to learn and grow.
            </p>
